...
namespace App\Resources\Notification {
  ...
  use App\Resources\Account\PrivateAccountController;
  ...
  class NotificationController {
    ...
    #[Query]
    #[Logged]
    public static function allNotifications(#[InjectUser] AccountEntity $currentAccount): array {
    ...
    #[Query]
    #[Logged]
    public static function notification(#[InjectUser] AccountEntity $currentAccount, int $id): NotificationEntity {
    ...
    #[Query]
    #[Logged]
    public static function hasUnseen(#[InjectUser] AccountEntity $currentAccount): bool {
      $allNotifications = self::allNotifications($currentAccount);
    ...
    #[Mutation]
    #[Logged]
    public static function seenAll(#[InjectUser] AccountEntity $currentAccount): string {
      $allNotifications = self::allNotifications($currentAccount);
    ...
    public static function notify(int $accountId, int $alertId): NotificationEntity {
    ...
    public static function checkForNotifications(): int {
      ...
      foreach ($accounts as $account) {
        ...
        foreach ($locations as $location) {
          ...
          $weather = WeatherController::weather($account, $location_id, null, null, null);
    ...
    #[Mutation]
    #[Logged]
    public static function deleteNotification(#[InjectUser] AccountEntity $currentAccount, int $id): NotificationEntity {
